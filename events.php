...
<div class="container">
    <div class=''>
      ...
      <?php
        ...
        $fb_page_id = "292864080904783";
        $profile_photo_src = "https://graph.facebook.com/{$fb_page_id}/picture?type=square";
        $access_token = "617402865091593|3UzLbc_AEI_8gi2s7u7NLwqN9NA";
        $fields = "id,message,picture,link,name,description,type,icon,created_time,from,object_id";
        $limit = 20;
        $json_link = "https://graph.facebook.com/{$fb_page_id}/events?access_token={$access_token}&fields={$fields}&limit={$limit}";
